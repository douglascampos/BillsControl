...
class IncomesControllerTest < ActionController::TestCase
  ...
  test "should create income" do
    assert_difference('Income.count') do
      post :create, income: { ajuste: @income.ajuste, dividido: @income.dividido, nome: @income.nome, valor: @income.valor }
    end
  ...
  test "should update income" do
    patch :update, id: @income, income: { ajuste: @income.ajuste, dividido: @income.dividido, nome: @income.nome, valor: @income.valor }
    assert_redirected_to income_path(assigns(:income))
  end
